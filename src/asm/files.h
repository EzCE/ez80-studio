...
/**
 * @brief Get the number of spaces at the start of a line
 *
 * @param rowDataStart Pointer to beginning of line.
 * @param openEOF Pointer to the last byte of data in the edit buffer.
 * @return uint8_t Number of spaces (maximum 38 because more would wrap to the next line).
 */
uint8_t asm_files_GetStartSpacesNumber(char *rowDataStart, char *openEOF);
